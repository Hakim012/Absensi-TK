                ...
                <input type="hidden" name="id" value="<?php echo $jrs->id ?>">
                  ...
                  <div class="form-group">
                    <label>Password</label>
                      <input type="password" name="password" class="form-control" placeholder="Isi Jika Ingin Mengganti Password Jika Tidak Biarkan Kosong">
                      <input type="hidden" name="passwordold" value="<?php echo $jrs->password ?>">
                  </div>
                  <div class="form-group">
                 <div class="form-group">
                    <label>Level</label>
